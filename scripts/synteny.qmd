...
final_result %>%
  ...
  geom_text(aes(label = length), vjust = -0.5, size = 3, check_overlap = TRUE) +
...
Построим график геномной окрестности гомологов phoD, центрируя по гомологу. Рамкой обозначим границы самого встречающегося гомолога.
